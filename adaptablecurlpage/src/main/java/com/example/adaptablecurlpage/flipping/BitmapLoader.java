...
public final class BitmapLoader {
    ...
    Bitmap getBitmap(int which_page) {
        ...
        if (bitmap!=null) {
            ...
            if (adapterPageFlipView!=null) {
                bitmap = takeScreenshot(adapterPageFlipView.getSelectedView(),false,Color.WHITE);
...
AdapterPageFlipView adapterPageFlipView;
    void LoadViews_for_Flipping(int previous_index, View previousView, int selected_index, View selectedView,
                                int next_index, View next_view, AdapterPageFlipView adapterPageFlipView) {
        this.adapterPageFlipView = adapterPageFlipView;
        sparseArray = new SparseArray<>();
        if (previousView != null) {
            Bitmap previous_page = takeScreenshot(previousView, false,adapterPageFlipView.getBackgroundColor());
        ...
        if (selectedView != null) {
            Bitmap selected_page = takeScreenshot(selectedView, false,adapterPageFlipView.getBackgroundColor());
        ...
        if (next_view != null) {
            Bitmap next_page = takeScreenshot(next_view, false,adapterPageFlipView.getBackgroundColor());
