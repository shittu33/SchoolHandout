...
//                }
        ...
        // draw stationary page without flipping
            ...
            DrawingState drawingState = mpageFlipView.adapterPageFlipView.getmDrawingState();
...
//                page.deleteAllTextures();
                ...
                Log.i(TAG1, "page Number is " + mPageNo);
                page.setFirstTexture(mBitmap);
                mpageFlipView.adapterPageFlipView.setmDrawingState(DrawingState.NORMAL_DRAW);
