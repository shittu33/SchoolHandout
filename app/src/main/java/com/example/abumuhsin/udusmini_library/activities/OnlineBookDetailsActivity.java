...
import com.example.abumuhsin.udusmini_library.fragments.Book_description_fragment;
...
//        int no_of_likers = intent.getIntExtra(LIKERS,0);
        ...
        if (handout != null) {
            ...
            handout_detail_adapter.addFragments(new Book_discussion_fragment(), "Discussion");
            handout_detail_adapter.addFragments(new Book_description_fragment(), "Description");
            handout_detail_adapter.addFragments(new Book_data_fragment(), "About");
