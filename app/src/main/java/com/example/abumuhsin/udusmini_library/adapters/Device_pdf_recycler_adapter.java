...
public class Device_pdf_recycler_adapter extends RecyclerView.Adapter<Device_pdf_recycler_adapter.ViewHolder> {
    ...
    public Device_pdf_recycler_adapter(Activity context, ArrayList<String> pdf_paths, PdfCLickListener pdfCLickListener) {
