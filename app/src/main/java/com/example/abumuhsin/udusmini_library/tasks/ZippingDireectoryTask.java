...
public class ZippingDireectoryTask extends AsyncTask<Void, File, File> {
    ...
    public ZippingDireectoryTask(MyBook_fragment myBook_fragment, File src_file
...
//                Log.i(ZIPTAG,src_file.listFiles().length + " files available to zip ");
    ...
    protected File doInBackground(Void... voids) {
        ...
        try {
            FileUtils.zipDirectory(fileToZip, fileToZip.getName() + "_share", zipOut, new FileUtils.OnDirectoryZipListener() {
                @Override
